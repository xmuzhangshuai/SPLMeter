...
public class VisualizerView extends View implements Visualizer.OnDataCaptureListener {
	...
	private static final int DN_W = 470;//view宽度与单个音频块占比 - 正常470 需微调
	private static final int DN_H = 360;//view高度与单个音频块占比360
	private static final int DN_SL = 5;//单个音频块宽度，原先15
	...
	protected final static int MAX_LEVEL = 60;//音量柱·音频块 - 最大个数,原先30

	protected final static int CYLINDER_NUM = 60;//音量柱 - 最大个数，原先26
	...
	public VisualizerView(Context context) {
		...
		mPaint.setColor(Color.argb(255, 7, 251, 251));//画笔颜色
